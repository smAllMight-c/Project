        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar-c">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="#"><i class="fas fa-arrows-alt-h"></i> ALLOT</a></li>
                    <li><a href="#"><i class="fas fa-table"></i> TIMETABLE</a></li>
                </ul>
                ...
                <table class="table table-bordered table-dark">
                    ...
                    <tbody id="myTable">
                        ...
                        while ($row = pg_fetch_row($ret)) {
                                ...
                                $sql=<<<EOF
                                select name from department where did=$row[5];
                                EOF;
                ...
                <div class="modal-body">
                    <form action="addteacherform.php" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="tdesignation" name="TD">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="tdepartment" name="TDP">
                                <?php
